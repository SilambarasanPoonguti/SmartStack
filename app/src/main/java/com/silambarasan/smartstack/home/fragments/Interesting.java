 ...
 */
public class Interesting extends Fragment {


    @Bind(R.id.interesting_list)
    RecyclerView mRecyclerView;
    @Bind(R.id.err_result_interesting)
    TextView err_result_questions;
    @Bind(R.id.interesting_progressBar)
    ProgressBar interesting_progressBar;

    private String TAG = Interesting.class.getSimpleName();
    ...
    private void initComponents() {
        try {
            if (isAdded()) {
                ...
                interesting_progressBar.setVisibility(View.GONE);
    ...
    // questions?page=1&pagesize=10&order=desc&sort=creation&site=stackoverflow
    private void getQuestions() {

        interesting_progressBar.setVisibility(View.VISIBLE);
        err_result_questions.setVisibility(View.GONE);
