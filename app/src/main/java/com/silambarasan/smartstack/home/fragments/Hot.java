...
public class Hot extends Fragment {
    ...
    @Bind(R.id.err_result_hot)
    TextView err_result_questions;
    @Bind(R.id.hot_progressBar)
    ProgressBar hot_progressBar;

    private String TAG = Hot.class.getSimpleName();
    ...
    private void initComponents() {
        try {
            if (isAdded()) {
                ...
                hot_progressBar.setVisibility(View.GONE);
    ...
    // questions?page=1&pagesize=10&order=desc&sort=hot&site=stackoverflow
    private void getQuestions() {
        hot_progressBar.setVisibility(View.VISIBLE);
        err_result_questions.setVisibility(View.GONE);
