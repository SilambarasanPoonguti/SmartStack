...
public class Featured extends Fragment {
    ...
    @Bind(R.id.err_result_featured)
    TextView err_result_questions;
    @Bind(R.id.featured_progressBar)
    ProgressBar featured_progressBar;


    private String TAG = Featured.class.getSimpleName();
    ...
    private void initComponents() {
        try {
            if (isAdded()) {
                ...
                featured_progressBar.setVisibility(View.GONE);
    ...
    // /featured?page=1&pagesize=10&order=desc&sort=activity&site=stackoverflow
    private void getQuestions() {
        featured_progressBar.setVisibility(View.VISIBLE);
        err_result_questions.setVisibility(View.GONE);
        ...
        try {
            if (null != response) {
                ...
                if (items.length() > 0) {
                    ...
                    showToast("You have not asked any questions");
